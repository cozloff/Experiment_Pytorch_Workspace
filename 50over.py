...
def evaluate_high_confidence_predictions(predictions_data, original_data, symbols, output_dir):
    """Evaluate performance only for predictions with confidence > 50%."""
    overall_actuals = []
    overall_predictions = []
    ...
    for symbol in symbols:
        ...
        high_confidence_df = merged_df[merged_df["Confidence"] > 0.5]
        ...
        report_lines = [
            f"Classification Report for {symbol} (Confidence > 50%):",
            report,
    ...
    if len(overall_actuals) > 0:
        ...
        overall_report_lines = [
            "Accumulated Classification Report (Confidence > 50% for all pairs):",
            overall_report,
