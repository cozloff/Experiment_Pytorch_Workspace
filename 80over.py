...
def evaluate_high_confidence_predictions(predictions_data, original_data, symbols, output_dir):
    """Evaluate performance only for predictions with confidence > 80%."""
    overall_actuals = []
    overall_predictions = []
    ...
    for symbol in symbols:
        ...
        high_confidence_df = merged_df[merged_df["Confidence"] > 0.8]
        ...
        report_lines = [
            f"Classification Report for {symbol} (Confidence > 80%):",
            report,
    ...
    if len(overall_actuals) > 0:
        ...
        overall_report_lines = [
            "Accumulated Classification Report (Confidence > 80% for all pairs):",
            overall_report,
...
def main():
    ...
    output_dir = "./high_confidence_80_analysis/"
