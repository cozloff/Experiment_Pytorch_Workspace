...
def process_file(file_info):
    ...
    for i in range(len(df)):
        ...
        # Check if there's a significant change within this window
        ...
        if upward and downward:
            label = 3  # Both upward and downward movement
        elif upward:
    ...
    text_filename = f"./train/{symbol.replace('/', '')}_data.txt"
    ...
    # Save the tensor
    tensor_filename = f"./train/{symbol.replace('/', '')}_data.pt"
